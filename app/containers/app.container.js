...
class AppContainer extends React.Component {
  ...
  randomTrack() {
    ...
    Axios.get(`https://api.soundcloud.com/playlists/261100022?client_id=${this.client_id}`)
      .then(function(response) {
        ...
        // Set the track state with a random track from the playlists
  ...
  togglePlay() {
    console.log("toggle play button");
  ...
  render() {
    ...
    return (
      <div className="scrotch_music" style={scotchStyle}>
        <Search
